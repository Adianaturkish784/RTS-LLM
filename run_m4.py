...
parser.add_argument('--lradj', type=str, default='half_decay', help='learning rate adjustment strategy')
...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        with open(record_path, 'a') as f:
            f.write("Epoch: {0} | Train Loss: {1:.7f} Vali Loss: {2:.7f} Test Loss: {3:.7f}\n".format(
